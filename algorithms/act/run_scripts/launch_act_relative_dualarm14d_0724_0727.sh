...
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/act_0724_0727_dualarm14d_relative_chunk16_b32_20k/train_out}"
STEPS="${STEPS:-20000}"
...
exec accelerate launch --num_processes=1 --mixed_precision=bf16 \
  ...
  --output_dir="$OUTPUT_DIR" --job_name="${JOB_NAME:-act_0724_0727_dualarm14d_relative_chunk16_b32_20k}"
