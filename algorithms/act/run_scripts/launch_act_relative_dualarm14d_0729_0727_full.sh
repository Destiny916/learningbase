...
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/act_0729_0727_dualarm14d_relative_3cam_full_chunk16_b32_100k/train_out}"
STEPS="${STEPS:-100000}"
...
exec accelerate launch --num_processes=1 --mixed_precision=bf16 \
  ...
  --output_dir="$OUTPUT_DIR" --job_name="${JOB_NAME:-act_0729_0727_dualarm14d_relative_3cam_full_chunk16_b32_100k}"
