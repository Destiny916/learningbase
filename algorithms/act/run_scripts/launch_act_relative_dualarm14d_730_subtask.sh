...
DATA_ROOT="${DATA_ROOT:-/data/wengyikun/datasets/joint_songling/730_subtask}"
STATS_ROOT="$DATA_ROOT/normalization"
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/act_730_subtask_dualarm14d_relative_chunk16_b32_100k/train_out}"
STEPS="${STEPS:-100000}"
SAVE_FREQ="${SAVE_FREQ:-10000}"

exec accelerate launch --num_processes=1 --mixed_precision=bf16 \
  -m lerobot.scripts.lerobot_train \
  --dataset.repo_id=local/730_subtask_dualarm14d_relative \
  ...
  --output_dir="$OUTPUT_DIR" --job_name="${JOB_NAME:-act_730_subtask_dualarm14d_relative_chunk16_b32_100k}"
