...
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/pi052_0806_relative_state_relative_action_task_en_chunk50_b4_400k_gpu0/train_out}"
KNOWLEDGE_INSULATION="${KNOWLEDGE_INSULATION:-true}"
JOB_NAME="${JOB_NAME:-pi052_0806_relative_state_relative_action_task_en_chunk50_b4_400k_gpu0}"
...
exec accelerate launch --num_processes=1 --mixed_precision=bf16 \
  ...
  --policy.knowledge_insulation="$KNOWLEDGE_INSULATION" \
