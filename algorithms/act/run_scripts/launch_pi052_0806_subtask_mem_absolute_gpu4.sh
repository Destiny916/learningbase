...
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/pi052_0806_subtask_mem_absolute_state_relative_action_chunk50_b1_400k_gpu4/train_out}"
...
exec accelerate launch --num_processes=1 --mixed_precision=bf16 \
  ...
  --job_name=pi052_0806_subtask_mem_absolute_state_relative_action_chunk50_b1_400k_gpu4
