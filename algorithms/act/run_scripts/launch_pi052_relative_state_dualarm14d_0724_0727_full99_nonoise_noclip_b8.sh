...
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/pi052_0724_0727_full99_relative_state_relative_action_task_en_base_chunk50_b8_100k_gpu1_20260805/train_out}"
JOB_NAME="${JOB_NAME:-pi052_0724_0727_full99_relative_state_relative_action_task_en_base_chunk50_b8_100k_gpu1}"

for path in \
  "$DATA_ROOT" \
  "$STATS_ROOT/relative_stats_manifest.json" \
  "$STATS_ROOT/relative_state_q01_q99.json" \
  "$STATS_ROOT/relative_action_chunk50_q01_q99.json" \
