...
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/pi05_0724_0727_full99_absolute_state_relative_action_nonoise_noclip_b16_100k_gpu7_20260804/train_out}"
JOB_NAME="${JOB_NAME:-pi05_0724_0727_full99_absolute_state_relative_action_nonoise_noclip_b16_100k_gpu7}"
...
for path in \
  ...
  "$ABS_STATS_ROOT/absolute_action_chunk50_q01_q99.json"; do
