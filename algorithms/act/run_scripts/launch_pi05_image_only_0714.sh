...
JOB_NAME="${JOB_NAME:-pi05_0714_image_only_chunk50}"
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/pi05_0714_image_only_chunk50/train_out}"
...
echo "condition_on_state=false chunk=50"
