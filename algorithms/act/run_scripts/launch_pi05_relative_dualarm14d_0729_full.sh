...
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/pi05_0729_dualarm14d_relative_3cam_full_base_chunk50_b16_100k/train_out}"
STEPS="${STEPS:-100000}"
...
exec accelerate launch --num_processes=1 --mixed_precision=bf16 \
  ...
  --output_dir="$OUTPUT_DIR" --job_name="${JOB_NAME:-pi05_0729_dualarm14d_relative_3cam_full_base_chunk50_b16_100k}"
