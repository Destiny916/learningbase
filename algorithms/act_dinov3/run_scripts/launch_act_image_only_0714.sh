...
JOB_NAME="${JOB_NAME:-act_0714_image_only_chunk16}"
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/act_0714_image_only_chunk16/train_out}"
...
echo "condition_on_state=false chunk=16"
