...
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/act_0729_stereo_top_rgbd_chunk16_b32_500k/train_out}"
STEPS="${STEPS:-500000}"
...
exec accelerate launch --num_processes=1 --mixed_precision=bf16 \
  ...
  --output_dir="$OUTPUT_DIR" --job_name="${JOB_NAME:-act_0729_stereo_top_rgbd_chunk16_b32_500k}"
