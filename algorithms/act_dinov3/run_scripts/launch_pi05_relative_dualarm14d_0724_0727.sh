...
DATA_ROOT="${DATA_ROOT:-/data/wengyikun/datasets/joint_songling/0724_0727_doublefripper_top_grippebread_combined_split_seed42_80train_19test}"
STATS_ROOT="$DATA_ROOT/normalization"
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/pi05_0724_0727_dualarm14d_relative_base_chunk50_b16_20k/train_out}"
STEPS="${STEPS:-20000}"
...
exec accelerate launch --num_processes=1 --mixed_precision=bf16 \
  ...
  --dataset.repo_id=local/0724_0727_doublefripper_top_grippebread_combined_train \
  --dataset.root="$DATA_ROOT/train" \
  --dataset.image_transforms.enable=false \
  --validation_dataset.repo_id=local/0724_0727_doublefripper_top_grippebread_combined_test \
  ...
  --output_dir="$OUTPUT_DIR" --job_name="${JOB_NAME:-pi05_0724_0727_dualarm14d_relative_base_chunk50_b16_20k}"
