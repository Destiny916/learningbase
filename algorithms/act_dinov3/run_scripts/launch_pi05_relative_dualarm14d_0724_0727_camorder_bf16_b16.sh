...
DATA_ROOT="${DATA_ROOT:-/data/wengyikun/datasets/joint_songling/0724_0727_doublefripper_top_grippebread_combined_full_99episodes}"
STATS_ROOT="$DATA_ROOT/normalization"
OUTPUT_DIR="${OUTPUT_DIR:-/data/wengyikun/outputs/pi05_0724_0727_full99_dualarm14d_relative_base_chunk50_b16_100k_camorder_top_left_right_visionbf16_20260803/train_out}"
DATASET_REPO_ID="${DATASET_REPO_ID:-local/0724_0727_doublefripper_top_grippebread_combined_full_99episodes}"
JOB_NAME="${JOB_NAME:-pi05_0724_0727_full99_dualarm14d_relative_camorder_top_left_right_visionbf16_b16_100k}"
