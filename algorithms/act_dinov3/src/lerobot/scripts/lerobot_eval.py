...
def _reset_rollout_state(
    ...
    """Reset policy and processor runtime state before an evaluation rollout."""
    policy.reset()
    preprocessor.reset()
    postprocessor.reset()
...
def rollout(
    ...
    # Reset the policy, processor runtime state, and environments.
    _reset_rollout_state(policy, preprocessor, postprocessor)
