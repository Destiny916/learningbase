...
class JointSonglingSwapEndpoint20Temporal2DataConfig(JointSonglingSwapEndpoint20DataConfig):
    """Previous/current three-camera visual context for PatchVision T2."""
...
ROBOT_TYPE_CONFIG_MAP = {
    ...
    "joint_songling_0812_closed_endpoint20_t2": JointSonglingSwapEndpoint20Temporal2DataConfig(),
}
...
DATASET_NAMED_MIXTURES = {
    ...
    "joint_songling_0812_closed_endpoint20_t2": [
        ("", 1.0, "joint_songling_0812_closed_endpoint20_t2")
    ],
}
