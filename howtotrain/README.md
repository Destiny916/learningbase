...
PC1/PC2 三模型启动器、相机/手部协议、relative/absolute state-action 转换、q01/q99、chunk 规则和新 W1 迁移方法见：

- [W1_Popcorn三模型_PC1_PC2推理部署总说明.md](W1_Popcorn三模型_PC1_PC2推理部署总说明.md)
- [W1_500000_absolute_checkpoint_audit.md](W1_500000_absolute_checkpoint_audit.md)
- [W1_PC2_ACT_direct_reference.md](W1_PC2_ACT_direct_reference.md)
- [W1_wrist_camera_usb_mapping.md](W1_wrist_camera_usb_mapping.md)
- 启动器目录：`/home/wengyikun/workplace/joint_songling/start`（含 `profiles/` 和 `preflight_w1_profile.py`）

上述 W1 文档与本文件的 TurboVLA 训练合同相互独立；进行 W1 真机推理时不要套用本文的 14D/50 步训练参数。
