"""Manager control for the isolated 200000 no-interpolation async client."""
...
def main() -> int:
    ...
    parser.add_argument("--config", default=str(Path(__file__).with_name("client_runtime_200000_nointerp_async.json")))
    ...
    if args.command == "status":
        ...
        result = controller.setup_config(client, {"data_type": "real", "inverse_gripper": False, "is_gripper_bool": False, "save_input": False})
