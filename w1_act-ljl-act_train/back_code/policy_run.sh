python3 w1_act_policy_inference_node.py --ros-args \
  -p policy_path:=/home/grabotics/workspace/act_inference/pick_doll/160000/pretrained_model \
  ...
  -p device:=cuda -p policy_hz:=30.0 -p tolerance_ms:=30.0 \
  ...
  #-p drop_joint_names:="['ANKLE','KNEE','BUTTOCK','WAIST']"
